...
const tyrant={name:'tyrannosaurus', diet:'carnivorous', weight:'7000kg', length:'12m', period:'Late Cretaceous'}
...
console.log(tyrant.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.

tyrant.roar=function(){
  return "RAWERSRARARWERSARARARRRR!"
}

console.log(tyrant.roar());
...
universities.sort((a,b)=>(a.toUpperCase()>b.toUpperCase())?1:-1)
...
const uni = universities.filter(item=>item.indexOf('Uni')>-1);
console.log(uni);
